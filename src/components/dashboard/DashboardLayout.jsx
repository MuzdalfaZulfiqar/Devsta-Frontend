...
//   return (
//     <div className="flex w-full min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white font-fragment transition-colors duration-300">
//       {/* Sidebar */}
//       <Sidebar
//         isOpen={isOpen}
//         setIsOpen={setIsOpen}
...
//           {/* Mobile */}
//           <div className="lg:hidden flex items-center justify-between p-4 border-b border-primary/20 bg-white dark:bg-black">
//             <img src="/devsta-logo.png" alt="Devsta Logo" className="h-11" />
//             <div className="flex items-center gap-4">
//               <NotificationBell
//                 notifications={notifications}
...
//         {/* Page Content */}
//         <main className="flex-1 p-6 overflow-y-auto bg-white dark:bg-black transition-colors duration-300">
//           {children}
//         </main>
//       </div>
//     </div>
