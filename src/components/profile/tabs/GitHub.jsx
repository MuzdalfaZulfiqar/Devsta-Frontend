            ...
            {stats.map(
              (stat) =>
                stat.value !== undefined && (
                  <div
                    key={stat.label}
                    className="bg-black border border-primary p-4 rounded-lg flex flex-col items-start hover:border-primary/40 transition"
                  >
              ...
              <div className="grid gap-3">
                {user.githubRepos.slice(0, 3).map((repo) => (
                  <a
                    ...
                    className="block bg-black p-4 rounded-lg border border-primary hover:border-primary/40 transition"
                  >
              ...
              <div className="flex gap-3 flex-wrap">
                {user.githubOrgs.map((org) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 bg-black rounded-lg border border-primary hover:border-primary/40 transition"
                  >
                    {org.avatar_url && (
