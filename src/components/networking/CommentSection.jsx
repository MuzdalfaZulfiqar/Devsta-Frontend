...
// export default function CommentSection({ postId, currentUserId, postAuthorId }) {
...
// {/* Existing Comments (indented) */}
//     <div className="pl-6">
//       {loading && <p className="text-gray-500 text-sm mt-2">Loading comments...</p>}
