...
export default function DeveloperJobCard({ job, onClick }) {
  ...
  className={`
    ...
    pt-12 pb-6 px-6               // ← increased top padding
...
>
  {hasApplied && (
    <div className="absolute top-4 left-5 z-20">     {/* now has more space above & left */}
      <span className="
  ...
  {/* rest remains the same */}
      ...
      <div className="flex items-start gap-4 mb-5">
        ...
        {company?.logo ? (
          <img
            ...
            className="w-14 h-14 rounded-xl object-cover border border-gray-200/80 group-hover:border-primary/40 transition-colors flex-shrink-0"
          />
        ) : (
          <div className="w-14 h-14 rounded-xl bg-gray-50 flex items-center justify-center border border-gray-200/80 group-hover:border-primary/40 transition-colors flex-shrink-0">
            <MdBusiness className="w-7 h-7 text-gray-400" />
          </div>
        )}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-4">
            ...
            {/* Salary - bigger & bolder */}
            {salaryInfo && (
              <div className="text-right flex-shrink-0">
                <p className="
                  font-extrabold text-2xl text-primary tracking-tight
                ">
                  {salaryInfo.amount}
                </p>
                <p className="
                  text-sm text-gray-500 font-medium mt-0.5
                ">
                  {salaryInfo.unit}
                </p>
              </div>
      ...
      <div className="flex flex-wrap gap-2.5 mb-5">
        <span className="
          ...
          bg-gray-100 text-gray-700 text-xs font-medium rounded-full
        ">
        ...
        <span className="
          inline-flex items-center gap-1.5 px-3.5 py-1.5 
          bg-primary/10 text-primary text-xs font-semibold rounded-full
        ">
        ...
        {remote && (
          <span className="
            ...
            bg-emerald-50 text-emerald-700 text-xs font-medium rounded-full
          ">
            Remote
          </span>
        )}
      ...
      <div className="
        ...
        mt-3 pt-4 border-t border-gray-100 
