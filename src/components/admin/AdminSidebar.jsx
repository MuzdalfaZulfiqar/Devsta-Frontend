// import { Users, FileText, Home, Settings, X, LogOut, MessageCircle } from "lucide-react";
// import { NavLink } from "react-router-dom";

// export default function AdminSidebar({ isOpen, setIsOpen, onLogout }) {
//   const menuItems = [
//     { label: "Dashboard", icon: Home, href: "/admin/dashboard" }, // default redirect to users
...
//             key={label}
//             to={href}
//             end={href === "/admin"} // dashboard default route
//             className={({ isActive }) =>
...
import { Users, FileText, Home, Settings, X, LogOut, MessageCircle, BarChart3 } from "lucide-react";
import { NavLink } from "react-router-dom";
