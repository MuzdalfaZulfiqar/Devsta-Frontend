...
export default function SkillsStep({ formData, setFormData, nextStep, prevStep }) {
  ...
  const canNext = Array.isArray(formData.topSkills) && formData.topSkills.length > 0;
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-primary">Skills</h2>
      <p className="text-sm text-gray-400">Select your top skills to showcase your expertise.</p>
