...
export default function CommunityPage() {
  ...
  // 👉 Initial load: pending connections (we no longer load unread community notifications here)
  useEffect(() => {
    (async () => {
      try {
    ...
    <DashboardLayout user={user}>
      <div className="flex flex-col w-full h-full">
        ...
        <div className="flex gap-6 pt-0.5 pb-0 py-1 border-b border-primary/20">
          ...
          {/* 🔥 Notifications tab REMOVED – use only the global/system notifications above */}
        </div>
