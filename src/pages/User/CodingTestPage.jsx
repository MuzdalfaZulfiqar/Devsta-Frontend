...
int main() {
  ...
  if (session?.challenges) {
    ...
    session.challenges.forEach((ch) => {
      ...
      // Select the correct template based on the default language
      const defaultLang = "javascript"; 
      
      initialStates[ch.challengeId] = {
        code: saved || LANGUAGE_TEMPLATES[defaultLang], // Provide the boilerplate!
...
const confirmSubmit = async () => {
  ...
  updateCurrentState({
    language: newLang,
    code: LANGUAGE_TEMPLATES[newLang],
  });
}}
